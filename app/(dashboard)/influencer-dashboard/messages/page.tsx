...
export default function MessagesDashboard() {
  ...
  useEffect(() => {
    ...
    if (userId) {
      let contact: Contact | undefined = mockContacts.find(
        (c) => c.id === Number.parseInt(userId)
      );
  ...
  return (
    <div className="h-screen bg-gray-50 flex relative">
      ...
      {/* <button
        ...
        className="fixed top-4 left-4 z-30 p-3 bg-white text-gray-700 rounded-full shadow-lg md:hidden border border-gray-200 hover:bg-gray-50 transition-all duration-200"
      >
            ...
            <div className="bg-white border-t border-gray-200 p-4 sticky bottom-0">
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  className="p-3 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 disabled:from-gray-300 disabled:to-gray-400 text-white rounded-full transition-all duration-200 flex-shrink-0 shadow-sm disabled:cursor-not-allowed"
                >
