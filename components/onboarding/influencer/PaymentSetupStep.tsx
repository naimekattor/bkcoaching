  ...
  return (
    <div className="space-y-8">
      ...
      <Alert>
        ...
        <AlertDescription>
          <strong>Payout Schedule:</strong> We process payments every Friday for
          completed campaigns. Payments are held for 48 hours after content
          approval to ensure brand satisfaction.
        </AlertDescription>
      </Alert>
      ...
      <Alert>
        ...
        <AlertDescription>
          ...
          payments or campaigns, our support team will help resolve them within
          48 hours. All payments are protected by our platform guarantee.
        </AlertDescription>
      </Alert>
